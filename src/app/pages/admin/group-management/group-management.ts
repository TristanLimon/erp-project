...
<p-dialog header="Añadir miembro por email" [(visible)]="showAdd" [modal]="true" [style]="{'width':'380px'}">
  ...
  styles: [`
    ...
    .perm-count { font-size:.78rem; background:#f3f4f6; color:#374151; padding:.2rem .6rem; border-radius:20px; font-weight:600; border:1px solid #e5e7eb; }

    /* ── Tabla forzada a modo claro ── */
    :host ::ng-deep .p-datatable { background:#fff !important; }
    :host ::ng-deep .p-datatable .p-datatable-table { background:#fff !important; }
    ...
    :host ::ng-deep .p-datatable-wrapper { border-radius:10px; overflow:hidden; border:1px solid #e5e7eb; }
  `]
})
